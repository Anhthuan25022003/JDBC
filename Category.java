...
import java.util.List;
	...
	public class Category {
		...
		public static List<Category> getlist() throws SQLException{
			Connection ketnoi=Connect.connect();
			Statement sta=ketnoi.createStatement();
			String chon="SELECT * FROM Category";
			ResultSet ketqua=sta.executeQuery(chon);
