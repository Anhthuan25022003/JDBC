...
//		// Sap xep theo gia giam dan
		List<Product> listproduct = Product.getListProductOfCategory(1);
		...
		try {
			...
			System.out.println("Ðã t?n t?i danh m?c này");
		}
		
		//Chinh sua 1 danh muc
		//Neu danh muc khong ton tai thi thong bao loi
		int rs = Category.editCategory(1, "edited");
		if(rs==0) {
...
//		}
		...
		//Xoa 1 san pham
		int rss = Product.deleteProduct(15);
		if(rss ==0) {
			System.out.println("khong tim thay san pham");
		}
		else {
